...
!  sub. PCDE4th05
!-------------------------------------------------------------------------------
   subroutine PCDE4th05(funcfp,f,func,funcm1,funcm2,funcm3,func_A,func_B,wkf1,wkf2,t,dt,Ndim)
!
!  Using 4th order Predict-Corrector Method to solve first order
!    differential equation of the form df/dt = funcfp
!    Preparing func, funcm1, funcm2, funcm3 from 4th-order Runge-Kutta method.
...
!
     implicit double precision (a-h,o-z)
     dimension :: f(1), func(1), funcm1(1), funcm2(1),funcm3(1),func_A(1),func_B(1)
     dimension :: wkf1(1), wkf2(1)
     external :: funcfp
!
!  f and funcm3 at t = 0
...
!  f and funcm2 at t = dt
!
     call RKDE4th(funcfp,f,funcm3,func_A,wkf1,wkf2,t,dt,Ndim)
!
!  f and funcm1 at t = 2*dt
!
     call RKDE4th(funcfp,f,func_A,func_B,wkf1,wkf2,t,dt,Ndim)
!
!  f and func at t = 3*dt
!
     call RKDE4th(funcfp,f,func_B,func_A,wkf1,wkf2,t,dt,Ndim)
!
!  f and funcm2 at t = 4*dt
!
     call RKDE4th(funcfp,f,func_A,func_B,wkf1,wkf2,t,dt,Ndim)
!
!  f and funcm1 at t = 5*dt
!
     call RKDE4th(funcfp,f,func_B,funcm2,wkf1,wkf2,t,dt,Ndim)
!
!  f and func at t = 6*dt
!
     call RKDE4th(funcfp,f,funcm2,func_A,wkf1,wkf2,t,dt,Ndim)
!
!  f and funcm2 at t = 7*dt
!
     call RKDE4th(funcfp,f,func_A,func_B,wkf1,wkf2,t,dt,Ndim)
!
!  f and funcm1 at t = 8*dt
!
     call RKDE4th(funcfp,f,func_B,func_A,wkf1,wkf2,t,dt,Ndim)
!
!  f and func at t = 9*dt
!
     call RKDE4th(funcfp,f,func_A,func_B,wkf1,wkf2,t,dt,Ndim)
!
!  f and funcm2 at t = 10*dt
!
     call RKDE4th(funcfp,f,func_B,funcm1,wkf1,wkf2,t,dt,Ndim)
!
!  f and funcm1 at t = 11*dt
!
     call RKDE4th(funcfp,f,funcm1,func_A,wkf1,wkf2,t,dt,Ndim)
!
!  f and func at t = 12*dt
!
     call RKDE4th(funcfp,f,func_A,func_B,wkf1,wkf2,t,dt,Ndim)
!
!  f and funcm2 at t = 13dt
!
     call RKDE4th(funcfp,f,func_B,func_A,wkf1,wkf2,t,dt,Ndim)
!
!  f and funcm1 at t = 14*dt
!
     call RKDE4th(funcfp,f,func_A,func_B,wkf1,wkf2,t,dt,Ndim)
!
!  f and func at t = 15*dt
!
     call RKDE4th(funcfp,f,func_B,func,wkf1,wkf2,t,dt,Ndim)
!
   end subroutine PCDE4th05
!==============================================================================
!===============================================================================
!===============================================================================
!--sub. PCDE4th1
